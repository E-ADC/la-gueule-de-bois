...
export const temoignagesApi = {
  ...
  // UC09 : invite par pseudo (l'invité doit déjà avoir un compte).
  inviteTemoin: (soireeId: number | string, pseudo: string) =>
    api.post<void>(`/soirees/${soireeId}/temoins`, { pseudo }),
